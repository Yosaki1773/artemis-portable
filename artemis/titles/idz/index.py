...
from .userdb import IDZKey, IDZUserDB
...
class IDZServlet(BaseServlet):
    ...
    async def render_GET(self, request: Request) -> bytes:
        ...
        return PlainTextResponse(
            ...
            headers={"Last-Modified": "Sun, 23 Apr 2023 05:33:20 GMT"},
        )
