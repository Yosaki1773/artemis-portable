...
class SaoStaticData(BaseData):
    ...
    async def put_hero(
        ...
        conflict = sql.on_duplicate_key_update(name=name, heroLogId=heroLogId)
    ...
    async def put_equipment(
        ...
        conflict = sql.on_duplicate_key_update(name=name, equipmentId=equipmentId)
    ...
    async def put_item(
        ...
        conflict = sql.on_duplicate_key_update(name=name, itemId=itemId)
    ...
    async def put_support_log(
        ...
        conflict = sql.on_duplicate_key_update(name=name, supportLogId=supportLogId)
    ...
    async def put_title(
        ...
        conflict = sql.on_duplicate_key_update(displayName=displayName, titleId=titleId)
    ...
    async def get_equipment_ids(
        self, version: int, enabled: bool
    ) -> Optional[List[Dict]]:
